...
fun LoginForm(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
        ...
        Column(
            ...
            Text(
                text = if (isEnglish) "Test accounts:" else "测试账号：",
                style = MaterialTheme.typography.bodySmall,
            ...
            Text(
                text = if (isEnglish)
                    "Account 1: testuser1@ucdconnect.ie / test123"
                else
                    "账号1: testuser1@ucdconnect.ie / test123",
                style = MaterialTheme.typography.bodySmall,
                color = Color(0xFF666666)
            )
            Text(
                text = if (isEnglish)
                    "Account 2: testuser2@ucdconnect.ie / test456"
                else
                    "账号2: testuser2@ucdconnect.ie / test456",
                style = MaterialTheme.typography.bodySmall,
                color = Color(0xFF666666)
            )
        }
